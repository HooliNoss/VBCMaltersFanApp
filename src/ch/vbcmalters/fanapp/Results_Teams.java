...
public class Results_Teams extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.resultsteams);
    ...
    private void init()
    {
        ...
        actionbar_title.setText("Ranglisten");
    ...
    private OnClickListener btnListener = new OnClickListener() {
        public void onClick(View v) {
        	...
        	Intent lNextIntent = new Intent(Results_Teams.this,Results.class);
    ...
    private OnClickListener btnHomeListener = new OnClickListener() {
        public void onClick(View v) {
        	Intent lNextIntent = new Intent(Results_Teams.this,VBCMaltersFanAppActivity.class);
        	startActivity(lNextIntent);
        }
    };
