...
public class PostNews extends Activity {
        ...
        public void onClick(View v) {
	    	...
	    	new AsyncTask<Integer, Integer, Boolean>()
	        {
	            ...
	            protected void onPreExecute()
	            {
	                 ...
	                 */
	                progressDialog = ProgressDialog.show(PostNews.this, "", "Loading...", false, true);
	            }
	            ...
	            protected Boolean doInBackground(Integer... params)
	            {
	                ...
	                try
	                {
	                    ...
	                    httppost = new HttpPost("http://volley.pulse-guild.ath.cx/SetNews.php");
	                    ...
	                    {
	        		       	  // Create new Dialog
	        		       	  final Dialog dialog = new Dialog(PostNews.this);
	        		       	  dialog.setTitle("Fehlerhafte Eingabe");
	        		       	  TextView txtDescription = new TextView(PostNews.this);
	            ...
	            protected void onPostExecute(Boolean result)
	            {
	                ...
	                if (result)
	                {
	                    //b.setMessage("Download succeeded");
				       	  Dialog dialog = new Dialog(PostNews.this);
	                ...
	                {
		                AlertDialog.Builder b = new AlertDialog.Builder(PostNews.this);
    ...
    private OnClickListener btnHomeListener = new OnClickListener() {
        public void onClick(View v) {
        	Intent lNextIntent = new Intent(PostNews.this,VBCMaltersFanAppActivity.class);
